...
def prepare_neural_modules():
    ...
    return front_camera, lane_detector, None, None, control_engine
...
def execute_hdp():
    ...
    front_camera, lane_detector, detection_engine, prediction_engine, control_engine = prepare_neural_modules()
    ...
    while True:
        ...
        # todo!: lane detection
        lane_offset = lane_detector.getLaneCurve(frame_resized, curLane=0, targetLane=0)
        # detection_engine.infer(frame_array)
        # lane_result = lane_detector.get_output()
